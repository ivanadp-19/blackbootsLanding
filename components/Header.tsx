...
const useStyles = createStyles((theme) => ({
  wrapper: {
    ...
    backgroundImage:
      'url(https://images.unsplash.com/photo-1580901369227-308f6f40bdeb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2672&q=80)',
